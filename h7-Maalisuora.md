...
Aloitusaika: Torstai 2025-03-06, kello 17.35.

Tässä tehtävässä kirjoitin ja ajoin tekstin "Hei maailma" kolmella kielellä. Valitsin kieliksi
...
Tässä tehtävässä laitoin Linuxiin uusi, itse tekemäni komennon, jota kaikki käyttäjät voivat ajaa.
